...
* [October - .NET Developer Days Warsaw - Qubits Are Vectors Too: The Math Behind Quantum Computing](...)
* [October - .NET Developer Days Warsaw - Hands-on building GenAI enabled .NET applications using the Microsoft Agent Framework](https://github.com/Djohnnie/MicrosoftAgentFrameworkWorkshop-DotNetDeveloperDays-Warsaw-2026)
* [October - .NET Assemble! - Cloud-Native Superpowers with Microsoft Orleans](https://github.com/Djohnnie/CloudNativeSuperpowersUsingOrleans-DotNetAssemble-2026.git)
* [July - Microsoft/Cronos - EUMaster4HPC Summer School 2026](https://github.com/Djohnnie/QuantumHandsOnLab-EUMaster4HPCSummerSchool-2026)
* [June - IlionX DevDays - Enable GenAI in your applications using .NET, Azure and the Microsoft Agent Framework](https://github.com/Djohnnie/EnableGenAIUsingTheMicrosoftAgentFramework-IlionxDevDays-2026)
...
* [October - VISUG - What is new in .NET 10 and C# 14](https://github.com/Djohnnie/DotNet10-VISUG-2025)
* [October - AP Hogeschool - Hallo, Azure Container Apps!](https://github.com/Djohnnie/HalloContainerApps-APHogeschool-2025)
* [October - Azure Dev Summit - Creating a quantum algorithm using Microsoft Q#](https://github.com/Djohnnie/CreatingQuantumAlgorithmUsingQSharp-AzureDevConf-2025)
...
* [May - Update Conference Krakow 2025 - Goodbye Azure Kubernetes Service! Hello Azure Container Apps!](https://github.com/Djohnnie/HelloAzureContainerApps-UpdateConferenceKrakow-2025)
* [May - Update Conference Krakow 2025 - Building cloud native applications using Microsoft Orleans!](https://github.com/Djohnnie/BuildingCloudNativeApplicationsUsingOrleans-UpdateConferenceKrakow-2025)
* [May - Team Rockstars IT - How comfortable are you with quantum computing - 's Hertogenbosch](https://github.com/Djohnnie/QuantumComputing-and-QSharp-TeamRockstarsIT-2025)
* [May - dotnetdays 2025 - Building your own AI Agent using Semantic Kernel](https://github.com/Djohnnie/BuildingAnAIAgentUsingSemanticKernel-Cronos-dotnetdays-2025)
...
* [April - Team Rockstars IT - How comfortable are you with quantum computing - Rotterdam](https://github.com/Djohnnie/QuantumComputing-and-QSharp-TeamRockstarsIT-2025)
...
* [January - UniPartners - Introduction to .NET and ASP.NET WebApi](https://github.com/Djohnnie/IntroductionToDotNetAndWebApi-UniPartners-2025)
* [Januari - Deloitte - What is new in .NET 9 and C# 13](https://github.com/Djohnnie/DotNet9-Deloitte-2025)

### 2024

* [December - CloudBrew - Deploy your cloud-native .NET 9 apps to Azure Container Apps](https://github.com/Djohnnie/AzureContainerApps-CloudBrew-2024)
* [December - On .NET Live - Enable GenAI in your applications using .NET 9 and Semantic Kernel](https://github.com/Djohnnie/BuildingAnAIAgentUsingSemanticKernel-OnDotNetLive-2024)
* [November - DotnetFriday - What is new in .NET 9 and C# 13](https://github.com/Djohnnie/DotNet9-DotnetFriday-2024)
* [November - Visug XL 2024 - Goodbye Azure Kubernetes Service! Hello Azure Container Apps!](https://github.com/Djohnnie/HelloAzureContainerApps-VisugXL-2024)
* [November - .NET Conf 2024 - How I used .NET 9 and AI to charge my electric car based on the available solar power](https://github.com/Djohnnie/MyHome-DotNetConf-2020)
...
* [June - .NET DeveloperDays Berlin 2024 - Creating a quantum algorithm using Microsoft Q#](https://github.com/Djohnnie/CreatingQuantumAlgorithmUsingQSharp-DotNetDeveloperDays-Berlin-2024)
* [June - NDC Oslo 2024 - Goodbye Azure Kubernetes Service! Hello Azure Container Apps!](https://github.com/Djohnnie/HelloAzureContainerApps-NDCOslo-2024)
* [June - IglooConf Summer Edition 2024 - Creating a quantum algorithm using Microsoft Q#](https://github.com/Djohnnie/CreatingQuantumAlgorithmUsingQSharp-IglooConf-2024)
* [May - IlionX DevDays 2024 - Creating a quantum algorithm using Microsoft Q#](https://github.com/Djohnnie/CreatingQuantumAlgorithmUsingQSharp-IlionX-DevDays-2024)
* [May - Microsoft Learn Zero to Hero Community - Building your own AI Agent using Semantic Kernel](https://github.com/Djohnnie/BuildingAnAIAgentUsingSemanticKernel-MicrosoftLearnZeroToHeroCommunity-2024)
* [May - Techorama Belgium 2024 - Goodbye Azure Kubernetes Service! Hello Azure Container Apps!](https://github.com/Djohnnie/HelloAzureContainerApps-Techorama-2024)
...
* [November - Build Stuff Appetizer 2023 - What is new in .NET 8](https://github.com/Djohnnie/DotNet8-BuildStuff-2023)
...
* [May - DevDays Europe 2023 - What is new in .NET 7 and C# 11](https://github.com/Djohnnie/DotNet7-DevDaysEurope-2023)
* [May - Techorama Belgium 2023 - Creating a quantum algorithm using Microsoft Q#](https://github.com/Djohnnie/CreatingQuantumAlgorithmUsingQSharp-Techorama-2023)
* [May - IlionX DevDays 2023 - Deep dive into Microsoft Orleans 7](https://github.com/Djohnnie/MicrosoftOrleansDeepDive-IlionX-DevDays-2023)
* [April - UniPartners - ASP.NET Core WebApi Security](https://github.com/Djohnnie/ASPNetWebApiSecurity-UniPartners-2023)
* [April - Cronos .NET Community - What is new in .NET and C#](https://github.com/Djohnnie/NewInDotNetAndCSharp-Cronos-DotNet-Community-2023)
* [April - Noest KSH - Azure Quantum & Microsoft Q#](https://github.com/Djohnnie/AzureQuantum-and-QSharp-Noest-KSH-2023)
...
* [October - .NET Developer Days - Introduction to project Orleans for your distributed applications](https://github.com/Djohnnie/IntroductionToOrleans-DotNetDeveloperDays-2022)
* [October - .NET Developer Days - Creating a quantum algorithm using Microsoft Q#](https://github.com/Djohnnie/CreatingQuantumAlgorithmUsingQSharp-DotNetDeveloperDays-2022)
* [October - .NET Developer Days - What is new in .NET 7 and C# 11](https://github.com/Djohnnie/DotNet7-DotNetDeveloperDays-2022)
* [October - .NET Developer Days - Hands-On building Cloud Native applications with .NET 6 and Azure](https://github.com/Djohnnie/CloudNativeApplicationsHandsOn-DotNetDeveloperDays-2022)
...
* **-6-** [October - .NET Developer Days - Building an Educational Game with .NET Core](https://github.com/Djohnnie/CSharpWars-DotNetDeveloperDays-2019)
* **-5-** [October - .NET Developer Days - Quantum Computing](https://github.com/Djohnnie/QuantumComputing-DotNetDeveloperDays-2019)
* **-4-** [September - ProgNET London - Building an Educational Game with .NET Core](https://github.com/Djohnnie/CSharpWars-ProgNET-London-2019)
* **-3-** [May - Techorama - Building an Educational Game with .NET Core](https://github.com/Djohnnie/CSharpWars)
* **-2-** [March - Momentum DevCon](https://github.com/Djohnnie/presentations-2019)
